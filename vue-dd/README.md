...
| get-own-properties | *false*                              | Boolean                 | Gets all objects' properties including the prototype properties, useful to get all properties of classes. Warning (using this on large objects like window can be very slow, use with caution on smaller class objects)                                                                                                                                                                                                                           |
