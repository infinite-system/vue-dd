...
| save-focus      | `true`                               | Boolean                 | Save-focus mode, will save save an element to open if you select an eye icon on it, very useful to quickly open and scroll to the needed sub-object / value. *Requires `ìd` or `name` prop to be set, anonymous save-focus is deprecated.*                                                                                                                                                                                                           |
